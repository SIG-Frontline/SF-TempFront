...
<div>
    ...
    <p class="my-3">
        SIG-Frontline is an organization of students building tools and
        applications for NJIT Students.
    </p>
    <a href="https://discord.gg/zPnuVJUMvQ" id="discord_button"
        >Join our Discord!</a
    >
</div>

<div class="my-5">
    <h2 class="text-2xl font-bold my-3">Projects</h2>
